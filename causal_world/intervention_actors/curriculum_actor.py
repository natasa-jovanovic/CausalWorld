...
class CurriculumInterventionActorPolicy(BaseInterventionActorPolicy):
    ...
    def act_ratio(self, variables_dict, ratio):
                ...
                for subvariable_name in self.task_intervention_space[variable]:
                    ...
                    if subvariable_name in ["size", "cylindrical_position", "mass"]:
                        interventions_dict[variable][subvariable_name] =\
                            ...
                            self.task_intervention_space[variable][subvariable_name][1] * ratio ** (1 / 3) + (1 - ratio ** (1 / 3)) * self.task_intervention_space[variable][subvariable_name][0])
                    # interventions_dict[variable][subvariable_name] =\
                    #     np.random.uniform(
