...
from causal_world.stable_baselines.common.policies import BasePolicy, nature_cnn, register_policy
from causal_world.stable_baselines.common.tf_layers import mlp
...
class FeedForwardPolicy(SACPolicy):
    ...
    def make_actor(self, obs=None, reuse=False, scope="pi"):
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            # the std depends on the state, so we cannot use causal_world.stable_baselines.common.distribution
