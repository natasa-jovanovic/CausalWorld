...
from causal_world.stable_baselines.common import explained_variance, ActorCriticRLModel, tf_util, SetVerbosity, TensorboardWriter
from causal_world.stable_baselines.common.runners import AbstractEnvRunner
from causal_world.stable_baselines.common.policies import ActorCriticPolicy, RecurrentActorCriticPolicy
from causal_world.stable_baselines.common.schedules import get_schedule_fn
from causal_world.stable_baselines.common.tf_util import total_episode_reward_logger
from causal_world.stable_baselines.common.math_util import safe_mean
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            for update in range(1, n_updates + 1):
                ...
                if self.verbose >= 1 and (update % log_interval == 0 or update == 1):
                    ...
                    with open(r"C:\Users\psiml8\CausalWorld\scripts\experiments-pushing\4\log.txt", "a") as file_object:
                        file_object.write(str(safe_mean([ep_info['r'] for ep_info in self.ep_info_buf])) + "," + str(t_start - t_first_start) + "\n")
                    logger.logkv('time_elapsed', t_start - t_first_start)
                    for (loss_val, loss_name) in zip(loss_vals, self.loss_names):
                        logger.logkv(loss_name, loss_val)
                        with open(r"C:\Users\psiml8\CausalWorld\scripts\experiments-pushing\4\log_loss.txt", "a") as file_object:
                            file_object.write(loss_name + ":" + str(loss_val) + ",")
                    logger.dumpkvs()
                    with open(r"C:\Users\psiml8\CausalWorld\scripts\experiments-pushing\4\log_loss.txt", "a") as file_object:
                        file_object.write("\n")
