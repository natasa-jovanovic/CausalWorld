...
import causal_world.stable_baselines.common.tf_util as tf_util
from causal_world.stable_baselines.common.tf_util import total_episode_reward_logger
from causal_world.stable_baselines.common import explained_variance, zipsame, dataset, fmt_row, colorize, ActorCriticRLModel, \
    SetVerbosity, TensorboardWriter
from causal_world.stable_baselines import logger
from causal_world.stable_baselines.common.mpi_adam import MpiAdam
from causal_world.stable_baselines.common.cg import conjugate_gradient
from causal_world.stable_baselines.common.policies import ActorCriticPolicy
from causal_world.stable_baselines.common.misc_util import flatten_lists
from causal_world.stable_baselines.common.runners import traj_segment_generator
from causal_world.stable_baselines.trpo_mpi.utils import add_vtarg_and_adv
...
class TRPO(ActorCriticRLModel):
    ...
    def setup_model(self):
        ...
        from causal_world.stable_baselines.gail.adversary import TransitionClassifier
