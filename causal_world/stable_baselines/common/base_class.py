...
from causal_world.stable_baselines.common.misc_util import set_global_seeds
from causal_world.stable_baselines.common.save_util import data_to_json, json_to_data, params_to_bytes, bytes_to_params
from causal_world.stable_baselines.common.policies import get_policy_from_name, ActorCriticPolicy
from causal_world.stable_baselines.common.runners import AbstractEnvRunner
from causal_world.stable_baselines.common.vec_env import (VecEnvWrapper, VecEnv, DummyVecEnv,
                                             VecNormalize, unwrap_vec_normalize)
from causal_world.stable_baselines.common.callbacks import BaseCallback, CallbackList, ConvertCallback
...
class OffPolicyRLModel(BaseRLModel):
    ...
    def is_using_her(self) -> bool:
        ...
        from causal_world.stable_baselines.her.replay_buffer import HindsightExperienceReplayWrapper
